        ...
        >
            <div className="flex flex-col h-full md:p-0  py-[10%] w-full">
                ...
                <div className="flex md:flex-row flex-col justify-center pt-[30px]">
                    ...
                    >
                        I'm a Software Development Engineer specializing in React Native and Next.js development. At FAE Bikes, I lead the development of high-impact applications handling 60L+ monthly transactions. With a focus on scalable solutions and performance optimization, I've consistently delivered features that enhance user experience and drive business growth.
                    </motion.p>
                </div>
            </div>
        </motion.div>
