        ...
        <div className="educationSection hidden show">
          ...
          <div className="lowerTab">
            <ul>
              ...
              Transitioned the Firebase backend of the mobile application to Supabase PostgreSQL, leading to a significant
decrease of 70% in bandwidth utilization.
              </li>
            </ul>
          </div>
        </div>
        <div className="educationSection hidden show">
          <p className=" tw-py-2 tw-text-[#89bbfe] tw-text-2xl">Frontend Developer Intern</p>
          ...
          <div className="lowerTab">
            <ul>
              ...
              <li className="institute">
              Enhanced the page loading speed and user experience by refactoring the codebase.
              </li>
              <li className="institute">
              Actively participated in team meetings and contributed ideas for improving the project management process.
              </li>
            </ul>
          </div>
        </div>
